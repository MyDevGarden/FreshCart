...
const Cart = () => {
    ...
    const {products, currency, cartItems, setCartItems, removeFromCart, getCartCount, 
            updateCartItem, navigate, getCartAmount, user, axios} = useAppContext();
        ...
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                ...
                <button onClick={() => {navigate('/products'); scrollTo(0,0)}}
                    ...
                    <img className="group-hover:-translet-x-1 transition" src={assets.arrow_right_icon_colored} alt="arrow" />
                    Continue Shopping
                </button>
